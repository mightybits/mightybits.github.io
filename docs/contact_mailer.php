...
$mail->Username = 'mightybitsweb@gmail.com';             // SMTP username
$mail->Password = 'D7SNKzc2?b0tYv';                           // SMTP password
$mail->SMTPSecure = 'tls';
$mail->Port = 587;                                    // TCP port to connect to
// Add the address to send the mail to
$mail->AddAddress('info@mighty-bits.com');
$mail->WordWrap = 50;                                 // Set word wrap to 50 characters
$mail->IsHTML(true);                                  // Set email format to HTML

// add your company name here
$company_name = 'Mighty Bits';
